...
interface JurisynthTOCClientProps {
  sections: readonly Section[];
}

export function JurisynthTOCClient({ sections }: JurisynthTOCClientProps) {
          ...
          <li key={id}>
            <a
              ...
              className={cn(
                ...
                active === id ? "text-white" : "text-white/30 hover:text-white/55"
              )}
              onClick={(e) => {
                e.preventDefault();
